...
const points = [
  {
    title: "7-Year Guided Path",
    main: "Step-by-step mentorship for holistic growth.",
    subs: ["₹5 Lakh insurance", "Expert mentorship"],
  },
  {
    title: "AI-Powered Learning",
    main: "Personalized education to maximize potential.",
    subs: ["Skill-gap analysis", "Pathing"],
  },
  {
    title: "Paid Internship Start at 2nd Year",
    main: "Clear pathways to employability.",
    subs: ["Industry alignment", "Expert sessions"],
  },
  {
    title: "Free B.Tech",
    main: "Quality higher education at zero cost.",
    subs: ["Hostel & Laptop", "Health coverage"],
  },
  {
    title: "Job Insurance ₹5 Lakh",
    main: "On legal Bond Paper.",
    subs: ["Security", "Career Assurance"],
  },
  {
    title: "Health Insurance for 7 Years",
    main: "Comprehensive coverage ensuring student well-being.",
    subs: ["Vitality Program", "Mental support"],
  },
  {
    title: "Personal Mentor",
    main: "One-on-one guidance throughout the learning journey.",
    subs: ["Leadership tracking", "Expert sessions"],
  },
  {
    title: "24/7 Doubt Clarification AI Chatbot",
    main: "Instant answers to all academic queries.",
    subs: ["AI Basics", "Real-time support"],
  },
  {
    title: "Ready-Made PDF Notes for Every Class",
    main: "Easy access to study materials.",
    subs: ["Digital Literacy", "Resource Access"],
  },
  {
    title: "Mock Interviews & Internship Training",
    main: "Practical exposure starting from 2nd year.",
    subs: ["Communication skills", "Placement prep"],
  },
  {
    title: "JoHeCa App",
    main: "Attendance tracking and real-time updates for parents and students.",
    subs: ["Real-time monitoring", "Progress tracking"],
  },
];
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="md:w-2/3 text-center md:text-left">
            <h1 className="text-4xl md:text-6xl font-extrabold leading-tight mb-6">
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#1a4b8c] via-blue-600 to-indigo-600">
                Empowering Students
              </span>
              <br />
              <span className="text-gray-900">with Knowledge, Skills &</span>
              <br />
              <span className="relative inline-block">
                <span className="relative z-10 text-gray-900">
                  Career Security
                </span>
                <span className="absolute left-0 bottom-1 w-full h-3 bg-blue-100 -z-0 rounded"></span>
              </span>
            </h1>

            <p className="text-lg md:text-xl text-blue-700 font-medium italic tracking-wide">
              Education that prepares you for life, career & the future 🚀
            </p>
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="flex flex-wrap gap-x-4 gap-y-1 pt-1">
                      {item.subs.map((sub, i) => (
                        <div
                          key={i}
                          className="flex items-center gap-1.5 text-[10px] text-neutral-400 font-medium"
                        >
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex flex-wrap gap-x-4 gap-y-2 pt-2">
                      {point.subPoints.map((sub, i) => (
                        <div
                          key={i}
                          className="flex items-center gap-1.5 text-[10px] text-neutral-400 font-bold uppercase tracking-wider"
                        >
